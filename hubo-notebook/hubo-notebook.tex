...
\item Updated Walker.cpp and tested it on Hubo without actually changing the trajectory, but somehow it caused some jittery behavior. I will investigate this tomorrow.
...
+=
\begin{bmatrix}
\cos(\theta_{HY}) && -\sin(\theta_{HY}) \\
\sin(\theta_{HY}) && \cos(\theta_{HY})
\end{bmatrix}
\begin{bmatrix}
f_x \\
f_y
