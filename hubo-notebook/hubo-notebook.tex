...
\item Determine if we need torso\_pitch variable for both biped and quadruped in zmp params
...
\item When transitioning to biped or quadruped the zmp/com moves right just slightly when centering zmp in bipedSupport.
\end{itemize}
